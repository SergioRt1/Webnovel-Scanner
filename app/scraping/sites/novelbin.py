...
class NovelBinSite(NormalSite):
    def __init__(self, browser):
        selectors = {
            ...
            '_get_author': '#novel > div.col-xs-12.col-sm-12.col-md-9.col-novel-main > div.col-xs-12.col-info-desc > div.col-xs-12.col-sm-8.col-md-8.desc > ul > li:nth-child(1) > a',
